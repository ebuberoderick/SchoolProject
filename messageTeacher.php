<?php $child = 'msgtrt'; $page = 'message'; include 'menu.php' ?>
...
<div class="main_body" style="margin-left:280px;overflow-x:hidden;padding:0px !important">
    ...
    <div class="row" style="margin-bottom:0px;height:40%;overflow-y:hidden;margin-top:-20px;">
        <div class="col-md-8 divf" style="padding:12px 2% !important">
            <div style="font-weight:bold;padding-left:5px"> All Teachers</div>
            <?php
                if($_SESSION['userType'] == 'teacher'){
                    ?>
                        <div class="adminMessageTeacher"></div>
                        <script>
                            function fetchlist21() {
                                $.ajax({
                                    url: 'adminMessageTeacher.php',
                                    success: function(returnData) {
                                        $('.adminMessageTeacher').html(returnData);
                                    }
                                });
                            }
                            fetchlist21();
                    ...
                    ?>
                        <div class="studentMessageTeacher"></div>
                        <script>
                            function fetchlist21() {
                                $.ajax({
                                    url: 'studentMessageTeacher.php',
                                    success: function(returnData) {
                                        $('.studentMessageTeacher').html(returnData);
                                    }
                                });
                            }
                            fetchlist21();
                    ...
                    ?>
                        <div class="parentMessageTeacher"></div>
                        <script>
                            function fetchlist21() {
                                $.ajax({
                                    url: 'parentMessageTeacher.php',
                                    success: function(returnData) {
                                        $('.parentMessageTeacher').html(returnData);
                                    }
                                });
                            }
                            fetchlist21();
        ...
        <div class="col-md-4 divs" style="overflow-y:scroll;overflow-x:hidden;height:100%">
            <div class="" style="padding-bottom:10px">
                <div style="padding-top:10px;">
                    <div style="font-weight:bold;padding-left:5px"> My Teachers</div>
